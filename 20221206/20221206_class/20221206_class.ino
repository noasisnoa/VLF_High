...
void loop() {
  ...
  switch(index){
    case -4 : Front_(1,60,100+100*index); break;
    case -3 : Front_(1,60,100+100*index); break;
    case -2 : Front_(1,60,100+100*index); break;
    case -1 : Front_(1,60,100+100*index); break;
    case 0 : Front_(1,100,120); break;
    case 1 : Front_(1,100+100*index,60); break;
    case 2 : Front_(1,100+100*index,60); break;
    case 3 : Front_(1,100+100*index,60); break;
    case 4 : Front_(1,100+100*index,60); break;
